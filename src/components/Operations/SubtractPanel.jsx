...
import { subtractQuantities } from '../../services/api'
...
function SubtractPanel() {
  ...
  return (
    <div className="card">
      <div className="card-title">➖ Subtraction</div>
